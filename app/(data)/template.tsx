export default[
    {
        name:'Blog Title',
        desc:'An AI tool that generates blog title that depends on your blog information',
        category:'Blog',
        icon:'https://cdn-icons-png.flaticon.com/128/6694/6694624.png',
        aiPrompt:'Give me 5 blog topic idea in bullet points only based on niche and outline give me result in rick text format editor',
